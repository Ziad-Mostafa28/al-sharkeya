      ...
      <div className={styles.footer}>
        <div className={styles.topIcons}>
          ...
          <div className={styles.item}>
            ...
            <Link to={'https://maps.app.goo.gl/xA5vS2VkRNyAqVKG8'} target="_blank"> {isArabic ? 'موقع المقر الرئيسى' : 'Headquarters Location'}</Link>
        ...
        <div className={styles.mainFooter}>
          ...
          <div className="row">
            ...
            <div className={`col-sm-6 col-md-4 col-lg-4 col-xl-2 ${styles.colSpacing}`}>
              ...
              <h2 className={styles.bottomtitle}><Link to='our-customer'>{isArabic ? "عملائنا" : "Our Customers"}</Link></h2>
            </div>
