...
import styles from "./PartenarsSection.module.css";
        ...
        <section className={styles.PartenarsSection}>
            ...
            {selected && (
                <div className={styles.modalOverlay} onClick={() => setSelected(null)}>
                    ...
                    >
                        <span className={styles.closeBtn} onClick={() => setSelected(null)}>
                            ✖
                        </span>

                        <h2 className={styles.modalTitle}>{selected.name}</h2>
                        <h3 className={styles.modalSubtitle}>
                            {selected.secondtitle}
                        </h3>
